...
## Languages and Tools
[![My Skills](https://skillicons.dev/icons?i=c,cpp,java,javascript,nodejs,nestjs,flask,fastapi,mongodb,postgresql,mysql,dynamodb,redis,prisma,postman,aws,nodejs,react,vercel,github,git,gitlab,docker,solidity,npm,yarn,pnpm,vite,vscode,ts)](https://skillicons.dev)
